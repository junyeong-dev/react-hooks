...
const useConfirm = (message = "", checkConfirm, rejectionConfirm) => {
    if(!checkConfirm || typeof checkConfirm !== "function"){
        return;
    }
    if(rejectionConfirm && typeof rejectionConfirm !== "function"){
        return;
    }    
    const confirmAction = () => {
